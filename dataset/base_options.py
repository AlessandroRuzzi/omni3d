...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # model stuff
        self.parser.add_argument('--model', type=str, default='pvqvae', choices=['pvqvae', 'rand_tf', 'resnet2vq', 'bert2vq', 'hoi2vq'], help='chooses which model to use.')
        ...
        self.parser.add_argument('--max_dataset_size', default=20, type=int, help='chooses how datasets are loaded. [mnist, sdf, abc, snet-abc]')
        ...
        # HOI stuff
        self.parser.add_argument('--hoi_cfg', type=str, default='configs/hoi.yaml', help='hoi model config file')

        # BEHAVE stuff
        self.parser.add_argument('--BEHAVE_train_cat', nargs='*', default=None, help='train categories for BEHAVE dataset, by default, all categories are used')
        ...
        # misc
        self.parser.add_argument('--save_tf_rec', default=False, type=bool, help='save the reconstructions of transformer')
        self.parser.add_argument('--val_for_visualization', default=False, type=bool, help='use validation data instead of test data for visualization')
