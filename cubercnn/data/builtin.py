...
def get_omni3d_categories(dataset="omni3d"):
    ...
    if dataset == "omni3d":
        ...
        cats = set({'backpack', 'basketball', 'boxlarge', 'boxlong', 'boxmedium','boxsmall', 'boxtiny', 'chairblack','chairwood', 'keyboard', 'monitor', 'plasticcontainer', 'stool', 'suitcase', 'tablesmall', 'tablesquare', 'toolbox', 'trashbin', 'yogaball', 'yogamat'})
        assert len(cats) == 20
    else:
